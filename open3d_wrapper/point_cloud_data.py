...
class PointCloudData:
    ...
    def __init__(self,frameset_wrapper,depth_scale):
        ...
        self._clipping_distance_in_meters =0.5 # meter
        self._pcd = None

    
    def get_color_intrinsic_matrix(self):
       color_intrinsic ,_ = self._frameset_wrapper.get_intrinsic()
       out = o3d.camera.PinholeCameraIntrinsic(640, 480, color_intrinsic.fx,
    ...
    def save_pcd(self):
        ...
        o3d.io.write_point_cloud("test.pcd", self._pcd)
